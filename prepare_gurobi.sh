...
# 3. Create a tarball from the gurobi folder
echo "Creating tarball from gurobi folder..."
tar -czf gurobi.tar.gz -C gurobiR gurobi

echo "Successfully created gurobi.tar.gz"
